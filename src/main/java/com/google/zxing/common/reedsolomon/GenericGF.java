...
public final class GenericGF {
    ...
    public static final GenericGF OW_CODE_FIELD_16 = new GenericGF(0x13, 16);  // x^4 + x + 1 
    public static final GenericGF RS_256_A = new GenericGF(0x011D, 256); // x^8 + x^4 + x^3 + x^2 + 1  [n=255, k=247, m=8, t=4]
    public static final GenericGF RS_256_B = new GenericGF(0x0187, 256); // x^8 + x^7 + x^2 + x + 1
